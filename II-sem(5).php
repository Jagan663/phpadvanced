	...
	<form action="#" method="post" enctype="multipart/form-data">
		<div class="row">
	  	<div class="leftcolumn">
		    <div class="card">
		    	<div class="formheading mb-2">Jagan's bank </div>
		    	<a href="II-sem(5)a">Create</a><br>
		    	<a href="II-sem(5)b">Debit</a><br>
		    	<a href="II-sem(5)c">Credit</a><br>
		    	<a href="II-sem(5)d">Balance Enquery</a><br>
		    </div>
		</div>
	</div>
	</form>
